...
<template>
  <div class="player-control">
    <div class="voice">
      ...
      <img style="width:20px;height:20px" src="../assets/icon/voice.png" alt="">
      <div v-if="isShow" class="popUp">
        <PlayerProgress progressWidth="100px" processColor="#01AAFF" musicProgressColor="#ebebeb" musicProgressHeight="4px" proBtnColor="#01AAFF" BtnWidthHeight="10px" />
      </div>
    </button>
    </div>
    <button @click="likeOrNot">
      <img v-if="unlike" style="width:18px;height:18px;" src="../assets/icon/unlike.png" alt="">
      <img v-else style="width:20px;height:20px;" src="../assets/icon/liked.png" alt="">
    </button>
